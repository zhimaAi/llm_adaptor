...
var chatProviderParameterFields = map[Provider]requestFieldSet{
	...
	ProviderCohere:      requestFields("frequency_penalty", "max_tokens", "presence_penalty", "response_format", "seed", "stop", "temperature", "tools", "top_p"),
	...
	ProviderOpenAIAgent: allOpenAIChatFields,
...
var embeddingProviderParameterFields = map[Provider]requestFieldSet{
	...
	ProviderOpenAIAgent: allOpenAIEmbeddingFields,
...
var imageProviderParameterFields = map[Provider]requestFieldSet{
	...
	ProviderOpenAIAgent: allOpenAIImageFields,
